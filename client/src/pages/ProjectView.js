  ...
  return (
    ...
    >
      <div className='mxw-sm w-full flex items-center flex-col justify-center space-y-6 text-left sm:text-center my-12'>
        ...
        <h2 className='animate animate__animated animate__fadeInDown animate__fast text-4xl md:text-6xl font-bold capitalize'>
          {project?.name}
        </h2>
        ...
        <div className='flex items-center space-x-2'>
          <a
            ...
            className='first-letter:text-2xl text-sm md:text-md first-letter:font-bold p-1 border-2 border-transparent hover:border-b-rose-600 duration-200'
          >
            Visit Project
          </a>
          <a
      ...
      <section className='mxw-sm my-12'>
        ...
        <p className='text-2xl md:text-3xl font-light first-letter:text-4xl first-letter:md:text-6xl first-letter:font-semibold'>
          {project?.overview}
        </p>
      </section>
      <div className='w-full my-12 max-w-[200px] mx-auto h-3 bg-gray-200' />
